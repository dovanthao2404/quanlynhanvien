...
console.log(document.querySelector('#list-staff__content > table > tbody'))
...
NhanVien.prototype.render = function () {
  ...
  <th>
    <div class="form-group mb-0">
      ...
      <input id="xoaNhanVien" class="btn btn-danger" type="button" value="Xóa">
    </div>
  </th>
</tr>`;
  document.querySelector('#list-staff__content > table > tbody').innerHTML += htmls;
}