...
getMyEle('timNhanVien').addEventListener("click", function () {
  ...
  <button id='btnSua_" + nv.maNV + "' class='btn btn-warning'>Sua</button>
  <button id='capNhat_" + nv.maNV + "' class='btn btn-warning btnCapNhat'>Cap Nhat</button>
  <button id='xoa_" + nv.maNV + "' class='btn btn-danger'>Xoa</button>
  `
})