...
function NhanVien(maNhanVien, ho, ten, ngaySinh, chucVu, ngayLamViec, luongCoBan, phuCap, ngayLam) {
...
NhanVien.prototype.render() {
  var htmls = `<tr>
  <th scope="row">${this.ten}</th>
  <th scope="col">${this.ho}</th>
  ...
  console.log(htmls);
  document.querySelector('#list-staff__content tboby').innerHTML = htmls;
