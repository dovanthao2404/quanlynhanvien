...
function kiemTraMa() {
  ...
  if (maNhanVien === '') {
    thongBaoMaNhanVien.innerHTML = mangThongBao[2];
  }
}
function kiemTraNgayLam() {
  var ngayLam = getMyEle('ngayLam').value;
  var thongBaoNgayLam = getMyEle('thongBaoNgayLam');
  if (ngayLam === '') {
    thongBaoNgayLam.innerHTML = mangThongBao[3];
  }
}
function kiemTraChucVu() {
  ...
  if (ngayLam === '') {
    kiemTraNgayLam.innerHTML = mangThongBao[3];
  }
}
